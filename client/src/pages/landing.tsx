                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      { name: "Trust", icon: <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none"><defs><linearGradient id="tw" x1="20" y1="2" x2="20" y2="38" gradientUnits="userSpaceOnUse"><stop stopColor="#0500FF"/><stop offset="1" stopColor="#0038FF"/></linearGradient></defs><path d="M20 2C20 2 36 9 36 20C36 31 36 33 36 33C36 33 29 38 20 38C11 38 4 33 4 33C4 33 4 31 4 20C4 9 20 2 20 2Z" fill="url(#tw)"/><path d="M20 8.5C20 8.5 30 13 30 20.5C30 28 30 29.5 30 29.5C30 29.5 26 33.5 20 34C14 33.5 10 29.5 10 29.5C10 29.5 10 28 10 20.5C10 13 20 8.5 20 8.5Z" fill="white"/></svg> },
                      ...
                      { name: "Uniswap", icon: <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="20" fill="#FF007A"/><path d="M15.2 10.8c-.32-.05-.34-.06-.16-.1.34-.08 1.14.03 1.72.22 1.36.45 2.6 1.56 3.68 3.3l.28.46.5-.08c2.14-.33 4.32.23 5.94 1.52.46.36 1.16 1.1 1.16 1.22 0 .03-.14.1-.32.14-.62.16-1.6.1-2.3-.14l-.46-.16-.22.24c-.28.3-.56.5-.96.66-.72.3-1.6.34-2.4.12-.14-.04-.26-.06-.26-.04 0 .04.3.46.54.72.54.58 1.14.96 2.56 1.6 1.36.62 2 1.02 2.56 1.6.6.62.96 1.28 1.12 2.06.1.48.04 1.44-.12 1.9-.46 1.32-1.56 2.32-3.02 2.74-.4.12-1.32.22-1.32.15l.14-.22c.3-.46.52-1 .6-1.46.04-.24.02-.32-.08-.52-.08-.16-.42-.52-.86-.92-1.34-1.18-1.7-1.72-1.98-2.94-.06-.28-.08-.5-.06-.78l.04-.42-.18-.16c-.66-.58-1.46-2-1.72-3.06-.1-.4-.14-1.16-.08-1.56l.04-.22-.16-.2c-.56-.7-.94-1.66-1-2.5-.04-.44.06-1.16.2-1.58.04-.1.04-.16 0-.2-.08-.06-.56-.32-.82-.42-.48-.2-1.06-.34-1.52-.38l-.34-.02z" fill="white"/><path d="M27.12 12.16c.04-.18.12-.36.14-.36.04 0 .26.18.42.34.3.3.5.66.64 1.1.08.26.08.36.08.96 0 .58 0 .7-.08.96-.14.44-.28.72-.58 1.08l-.22.26.06-.32c.08-.5.06-1.32-.06-1.76-.12-.48-.32-.92-.56-1.22l-.12-.14.06-.26.22-.64z" fill="white"/></svg> },
                    ].map((wallet) => (
