                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      { name: "Trust", icon: <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none"><path d="M20 4C20 4 33 10 33 18C33 26 33 28 33 28C33 28 27 34 20 36C13 34 7 28 7 28C7 28 7 26 7 18C7 10 20 4 20 4Z" fill="#0500FF"/><path d="M20 9C20 9 28.5 13.5 28.5 19C28.5 24.5 28.5 26 28.5 26C28.5 26 24.5 30.5 20 32C15.5 30.5 11.5 26 11.5 26C11.5 26 11.5 24.5 11.5 19C11.5 13.5 20 9 20 9Z" fill="white"/><path d="M20 13C20 13 25 16 25 20C25 24 25 25 25 25C25 25 23 28 20 29C17 28 15 25 15 25C15 25 15 24 15 20C15 16 20 13 20 13Z" fill="#0500FF"/></svg> },
