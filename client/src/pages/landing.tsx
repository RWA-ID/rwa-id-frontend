                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      { name: "Trust", icon: <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none"><defs><linearGradient id="tw" x1="20" y1="2" x2="20" y2="38" gradientUnits="userSpaceOnUse"><stop stopColor="#48FF91"/><stop offset="1" stopColor="#0094FF"/></linearGradient></defs><path d="M20 4C20 4 8 10 8 10C8 10 8 22 8 26C8 30 20 38 20 38C20 38 32 30 32 26C32 22 32 10 32 10C32 10 20 4 20 4Z" fill="url(#tw)"/><path d="M20 9C20 9 12 13.5 12 13.5C12 13.5 12 22.5 12 25.5C12 28.5 20 34 20 34C20 34 28 28.5 28 25.5C28 22.5 28 13.5 28 13.5C28 13.5 20 9 20 9Z" fill="white"/></svg> },
