          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4">
              <div className="flex items-center justify-center gap-2">
                ...
                <h2 className="font-heading text-2xl font-bold">Security & Transparency</h2>
              </div>
              <p className="text-muted-foreground">
                The RWA-ID smart contracts are open-source and verified on Linea.
              </p>
              <p className="text-muted-foreground">
                An automated security analysis was performed using SolidityScan.
              </p>
              <div className="pt-4">
                <a
              ...
              <p className="text-xs text-muted-foreground pt-2">
                This report is generated by an automated tool and does not constitute a formal third-party evaluation.
              </p>
            </div>
          </div>
        </section>
