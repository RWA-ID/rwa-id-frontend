...
import trustWalletLogo from "@assets/Trust_Wallet_Core_Logo_Blue_1771203175513.png";
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      { name: "Trust", icon: <img src={trustWalletLogo} alt="Trust Wallet" className="w-5 h-5 object-contain" /> },
